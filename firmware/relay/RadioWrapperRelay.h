#ifndef RadioWrapperRelay_h
#define RadioWrapperRelay_h
...
class RadioWrapperRelay{              //Wrapper class for the rfm69 library- this will make it much easier to work with the radio
  private:                            //Private- can't access these directly
    const int NETWORKID=0;            //Must be the same for all nodes (0 to 255)
    const int MYNODEID=1;             //My node ID (0 to 255) (relay radio is 1)
    const int TONODEID=2;             //Destination node ID (0 to 254, 255 = broadcast) (robot radio is 2)
